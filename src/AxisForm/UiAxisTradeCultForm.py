...
class Ui_AxisTradeCultForm(object):
    def setupUi(self, AxisTradeCultForm):
        ...
        self.ChartPageStockInGroupComboBox.setGeometry(QtCore.QRect(650, 20, 81, 31))
        self.ChartPageStockInGroupComboBox.setObjectName("ChartPageStockInGroupComboBox")
        self.ChartPageGraphTypeComboBox = QtWidgets.QComboBox(self.tabChart)
        self.ChartPageGraphTypeComboBox.setGeometry(QtCore.QRect(740, 20, 91, 31))
        self.ChartPageGraphTypeComboBox.setObjectName("ChartPageGraphTypeComboBox")
