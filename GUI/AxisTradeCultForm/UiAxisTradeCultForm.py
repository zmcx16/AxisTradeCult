...
class Ui_AxisTradeCultForm(object):
    def setupUi(self, AxisTradeCultForm):
        ...
        self.TechIndicatorsListWidget.setGeometry(QtCore.QRect(510, 70, 421, 351))
        ...
        self.ShowButton.setGeometry(QtCore.QRect(880, 20, 51, 31))
