...
class Ui_AxisTradeCultForm(object):
    def setupUi(self, AxisTradeCultForm):
        ...
        self.AvgC3MLabel.setGeometry(QtCore.QRect(430, 50, 60, 31))
        ...
        self.AvgV3MLabel.setGeometry(QtCore.QRect(640, 50, 60, 31))
        ...
        self.GraphSampleButton.setGeometry(QtCore.QRect(820, 53, 51, 25))
        ...
        self.Stockline.setGeometry(QtCore.QRect(500, 10, 71, 31))
        self.Stockline.setObjectName("Stockline")
        self.AddButton = QtWidgets.QPushButton(self.tabOverview)
        self.AddButton.setGeometry(QtCore.QRect(590, 10, 71, 31))
